...
<header className="text-dr bg-br body-font border-b-2 border-b-dr">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <button className="inline-flex text-white items-center bg-dr border-0 py-1 px-3 focus:outline-none hover:bg-yellow-600 rounded text-base mt-4 md:mt-0">Login
